...
usage() { echo "Usage: update_status.sh -f <fileName> -s <status> -n <name>" 1>&2; exit 1; }
...
# If you want to use the --auth-mode login, enable this comment.
# az role assignment create --role "Storage Blob Data Contributor" --assignee <YOUR_E_MAIL> --scope "/subscriptions/<YOUR_SUBSCRIPTION>/resourceGroups/<YOUR_RESOURCE_GROUP/providers/Microsoft.Storage/storageAccounts/${storageAccountName}/blobServices/default/containers/${container}"
